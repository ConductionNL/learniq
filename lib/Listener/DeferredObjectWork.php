...
/**
 * Scholiq Deferred Object Work contract
 *
 * @category Listener
 ...
 * it does is latency the learner pays for a result they have already earned.
 * Such a listener's `handle()` keeps only the cheap in-memory filtering — the
 * register/schema guard and any short-circuit answerable from the event payload
 * alone — and hands an entry to
 * {@see \OCA\Scholiq\BackgroundJob\DeferredObjectListenerJob} through

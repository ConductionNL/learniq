...
class Application extends App implements IBootstrap
{
    ...
    private function registerCollaborationListeners(IRegistrationContext $context): void
    {
        ...
        // from boot(). The ObjectTransitionedEvent half stays a plain
        // registration — it already only fires on a lifecycle transition, and it
        // reads the event's own getRegister()/getSchema(), not the written
        // object's.
        $context->registerEventListener(
            event: ObjectTransitionedEvent::class,
     ...
     * register() has run. See {@see self::registerFilteredObjectListener()}.
     *

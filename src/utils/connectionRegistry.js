 ...
 * 2.37.0 ships neither formatter, so learniq carries this copy. The names are
 ...
 * the module runs under `node --test` with nothing mocked.
 *
 ...
 */
export const INTEGRIQ_CONNECTIONS_PATH = '/apps/integriq/connections?app=learniq&link=1'

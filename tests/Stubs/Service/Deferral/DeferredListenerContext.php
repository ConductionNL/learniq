 ...
 * plus the accessors are byte-identical to the real ones, so a test that passes
 * here passes against the real class.
 *
...
if (class_exists(DeferredListenerContext::class) === false) {
	/**
	 * Mirror of OpenRegister's DeferredListenerContext for standalone Scholiq unit tests.
	 */
